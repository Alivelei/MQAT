...
def compute_norm(files):
    ...
    # R_mean: 67.440192, G_mean: 67.324019, B_mean: 67.341800
    # R_std: 70.591654, G_std: 70.617967, B_std: 70.620317


if __name__ == '__main__':
    xm_path = train_configure["dataset"]["dataset_xm_path"]
    queries = json.load(open(train_configure["dataset"]["dataset_path"], encoding="utf-8"))
